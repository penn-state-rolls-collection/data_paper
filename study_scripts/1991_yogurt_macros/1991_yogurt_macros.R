...
# load
diff_data <- read_excel('/Users/azp271/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/Rolls, Barbara Jeans files - Archived Study Data 1988-1999/1990 EatDis Salad Preload - SSS & VAS only/Data - Excel from SPSS sys files/DifSSS.xls', na = c(999, ''))

hunger_data <- read_excel('/Users/azp271/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/Rolls, Barbara Jeans files - Archived Study Data 1988-1999/1990 EatDis Salad Preload - SSS & VAS only/Data - Excel from SPSS sys files/HungerDat.xls', na = c(999, ''))

sss_exp3_data <- read_excel('/Users/azp271/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/Rolls, Barbara Jeans files - Archived Study Data 1988-1999/1990 EatDis Salad Preload - SSS & VAS only/Data - Excel from SPSS sys files/SSS1.xls', na = c(999, ''))
