...
participant_list <- list(
  ...
  "description" = "Demographic data related to participants in the 1991 Eating Disorders Study",
    ...
    list("name" = "smell_study", 
         ...
         "valueReference" = list(
           ...
           list( "value" = "1",
                 "label" = "yes")),
         "@type" = "PropertyValue"),
    list("name" = "vas_hourly_study", 
         "description" = "participant is represented in data for the Hourly VAS Study",
         "valueReference" = list(
           list( "value" = "0",
                 "label" = "no"),
           list( "value" = "1",
                 "label" = "yes")),
         "@type" = "PropertyValue"),
    list("name" = "yogurt_preload_study", 
         "description" = "participant is represented in data for the Yogurt Preload Study",
         "valueReference" = list(
           list( "value" = "0",
                 "label" = "no"),
           list( "value" = "1",
                 "label" = "yes")),
         "@type" = "PropertyValue"),
    list("name" = "deprivation_study", 
         "description" = "participant is represented in data for the Food Deprivation Study",
         "valueReference" = list(
           list( "value" = "0",
                 "label" = "no"),
           list( "value" = "1",
