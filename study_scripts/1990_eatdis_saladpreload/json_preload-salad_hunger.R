...
salad_hunger_list <- list(
  ...
  "@type" = "Dataset",
  "name" = "assay-hunger_data",
  "description" = "Hunger ratings for food attributes across 3 preload conditions in the study titled: High- vs. Low-Calorie Preloads and Appetite Regulation in Eating Disorder Inpatients: Partial data from a 1990 Study",
  "isPartOf" = "",
